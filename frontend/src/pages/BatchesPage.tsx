...
type B = { id: number; code: string; product_name?: string; oven_label?: string; start_min: number; ferment_end?: number; bake_end?: number; status: string; proof_off_oven?: boolean };
...
export default function BatchesPage() {
  ...
  return (<>
    ...
    <tbody>{rows.map(b => <tr key={b.id}><td className="mono">{b.code}</td><td>{b.product_name}{b.proof_off_oven && <span className="off-oven-tag">离炉</span>}</td><td>{b.oven_label}</td>
